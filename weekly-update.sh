...
# ------------------------------------------------------------------------------
# STEP 2c: (REMOVED Sep 2026) GUS delete-case fetch is no longer needed —
#   UTDP files are now shared directly, so offboarded/deleted jobs no longer
#   appear in the export and there is nothing stale to exclude.
# ------------------------------------------------------------------------------
